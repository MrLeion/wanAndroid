...
/**
 * @desc activity管理类
 * @date 2017/12/13 下午5:11.
 */

public class ActivityManager {

    final static String TAG = "ActivityManager";
...
//            activity.finish();
//        }
//        LogUtil.i(TAG, "pop = " + activity);
//    }

    /**
     * add this activity to stack
     */
    public static void add(Activity activity) {
        LogHelper.i(TAG, "push = " + activity);
        STACK.pushToStack(activity);
    }
    ...
    public static void remove(Activity activity) {
        LogHelper.i(TAG, "remove = " + activity);
    ...
    public static void onExit() {
        ...
        if (now <= lastExitPressedMills + MAX_DOUBLE_EXIT_MILLS) {
            ...
            if (null != peek()) {
                ToastHelper.toast(R.string.app_exit);
            }
    ...
    public static void finishAll() {
        ...
        while (!STACK.isEmpty()) {
            final Activity activity = STACK.popFromStack();
            if (activity != null) {
                LogHelper.i(TAG, activity.toString());
                activity.finish();
                if (null != operations) {
