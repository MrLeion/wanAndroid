package tzl.com.framework.share.view2image;
...
/**
 * author: tangzenglei
 * created on: 2018/12/20 6:56 PM
 * description: view 转换成长图或者一般截图
 */
...
//        final Bitmap bitmap = generateBigBitmap(viewGroup, width);
        final Bitmap bitmap = getSimpleView2Bitmap(viewGroup, width);
    ...
    public interface OnImageSavedCallback {
         void onFinishCallback(String path);
    }
     ...
     * @return Bitmap
     */
    public static Bitmap getSimpleView2Bitmap(final View view, int width) {
        if (view.getWidth() <= 0 || view.getHeight() <= 0) {
            view.measure(View.MeasureSpec.makeMeasureSpec(width, View.MeasureSpec.EXACTLY),
                    View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED));
            view.layout(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight());
     ...
     * @return Bitmap
     */
    public static Bitmap getSimpleView2Bitmap(final View view) {
        return getSimpleView2Bitmap(view,0);
    }
