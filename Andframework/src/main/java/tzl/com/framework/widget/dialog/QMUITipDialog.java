...
import tzl.com.framework.widget.SafeImageView;
        ...
        public QMUITipDialog create() {
            ...
            switch (mCurrentIconType) {
                case ICON_TYPE_LOADING:
                    ...
                    loadingView.setSize(DensityHelper.dp2px(mContext, 32));
                ...
                case ICON_TYPE_FAIL:
                case ICON_TYPE_INFO:
                    SafeImageView imageView = new SafeImageView(mContext);
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = DensityHelper.dp2px(mContext, 12);
                }
