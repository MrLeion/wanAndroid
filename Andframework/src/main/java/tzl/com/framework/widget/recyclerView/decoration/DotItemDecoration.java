package tzl.com.framework.widget.recyclerView.decoration;
...
import tzl.com.framework.widget.recyclerView.listener.SpanIndexListener;
...
public class DotItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class Builder {
        ...
        public Builder setTopDistance(float distance) {
            mConfig.mTopDistance = DensityHelper.dp2px(mContext, distance);
            return this;
        }

        public Builder setItemPaddingLeft(float itemPaddingLeft) {
            mConfig.mItemPaddingLeft = DensityHelper.dp2px(mContext, itemPaddingLeft);
            return this;
        }

        public Builder setItemPaddingRight(float itemPaddingRight) {
            mConfig.mItemPaddingRight = DensityHelper.dp2px(mContext, itemPaddingRight);
            return this;
        }

        public Builder setItemInterVal(float interval) {
            mConfig.mItemInterval = DensityHelper.dp2px(mContext, interval);
            return this;
        }

        public Builder setLineWidth(float lineWidth) {
            mConfig.mLineWidth = DensityHelper.dp2px(mContext, lineWidth);
            return this;
        }
        ...
        public Builder setDotPaddingTop(int paddingTop) {
            mConfig.mDotPaddingTop = DensityHelper.dp2px(mContext, paddingTop);
            return this;
        }
        ...
        public Builder setDotRadius(int dotRadius) {
            mConfig.mDotRadius = DensityHelper.dp2px(mContext, dotRadius);
            return this;
        }
        ...
        public Builder setTextSize(float textSize) {
            mConfig.mTextSize = DensityHelper.sp2px(mContext, textSize);
            return this;
        }

        public Builder setDotPaddingText(float dotPaddingText) {
            mConfig.mDotPaddingText = DensityHelper.dp2px(mContext, dotPaddingText);
            return this;
        }
        ...
        public Builder setBottomDistance(float bottomDistance) {
            mConfig.mBottomDistance = DensityHelper.dp2px(mContext, bottomDistance);
            return this;
        }
