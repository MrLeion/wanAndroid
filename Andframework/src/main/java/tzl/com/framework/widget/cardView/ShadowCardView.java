...
/**
 * author: tangzenglei
 * created on: 2018/10/30 下午4:08
 * description: 可改变阴影颜色的 Cardview
 */
public class ShadowCardView extends CardView {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public boolean getUseCompatPadding() {
            return ShadowCardView.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return ShadowCardView.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            ShadowCardView.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                ShadowCardView.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                ShadowCardView.super.setMinimumHeight(height);
            }
        }
    ...
    public ShadowCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.CardView, defStyleAttr,
                R.style.CardView);
        if (a.hasValue(R.styleable.CardView_cardBackgroundColor)) {
            mBackgroundColor = a.getColorStateList(R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            mBackgroundColor = ColorStateList.valueOf(hsv[2] > 0.5f
        ...
        mRadius = a.getDimension(R.styleable.CardView_cardCornerRadius, 0);
        mElevation = a.getDimension(R.styleable.CardView_cardElevation, 0);
        mMaxElevation = a.getDimension(R.styleable.CardView_cardMaxElevation, 0);
        ...
        IMPL.initialize(mCardViewDelegate, context, mBackgroundColor, mRadius,
                mElevation, mMaxElevation, shadowColorStart, shadowColorEnd);
    }
    ...
    public void setShadowColor(int color) {
        IMPL.initialize(mCardViewDelegate, mContext, mBackgroundColor, mRadius,
                mElevation, mMaxElevation, ColorStateList.valueOf(color), ColorStateList.valueOf(color));
    }
