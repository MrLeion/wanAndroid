...
import static tzl.com.framework.widget.recyclerView.layoutManager.CardConfig.MAX_SHOW_COUNT;
import static tzl.com.framework.widget.recyclerView.layoutManager.CardConfig.SCALE_GAP;
import static tzl.com.framework.widget.recyclerView.layoutManager.CardConfig.TRANS_Y_GAP;

/**
 * author: tangzenglei
 * created on: 2018/10/19 下午3:07
 * description:
 */
public class OverlayCallback  extends ItemTouchHelper.SimpleCallback  {

    protected RecyclerView mRv;
    protected List mDatas;
    protected RecyclerView.Adapter mAdapter;

    public OverlayCallback(RecyclerView rv, RecyclerView.Adapter adapter, List datas) {
        this(0,
                ItemTouchHelper.DOWN | ItemTouchHelper.UP | ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT,
                rv, adapter, datas);
    }

    public OverlayCallback(int dragDirs, int swipeDirs
