package tzl.com.framework.widget.flowLayout;
...
public class TagFlowLayout extends FlowLayout
    ...
    public interface OnTagClickListener {
        boolean onTagClick(View view, int position, TagAdapter adapter);
    }
    ...
    public void setMaxSelectCount(int count) {
        ...
        mSelectedMax = count;
        Log.w(TAG, "you has already select"+mSelectedView.size() +" more than " + count + " views , so it will be clear .");
    }
    ...
    private void setChildChecked(int position, TagView view) {
        if (mTagAdapter.onSelected(position, view.getTagView())) {
            view.setChecked(true);
        }
    }

    private void setChildUnChecked(int position, TagView view) {
        if (mTagAdapter.unSelected(position, view.getTagView())) {
